  ...
  return (
    <footer className="relative w-full min-w-0 overflow-hidden border-t border-neutral-900 bg-neutral-950 text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-16 pt-14 md:pb-20 md:pt-16">
        {/* Pre-footer CTA */}
        <section className="relative mb-14 overflow-hidden rounded-[24px] p-7 shadow-[0_22px_56px_rgba(0,0,0,0.42),0_0_24px_rgba(255,255,255,0.08)] backdrop-blur-[12px] md:mb-16 md:p-10">
          <motion.div
            aria-hidden
            className="pointer-events-none absolute inset-0 rounded-[24px] p-[1.2px]"
            animate={{ rotate: 360 }}
            transition={{ duration: 10.5, ease: "linear", repeat: Infinity }}
          >
            <div className="h-full w-full rounded-[23px] bg-[conic-gradient(from_0deg,rgba(255,255,255,0)_0deg,rgba(255,255,255,0.04)_38deg,rgba(255,255,255,0.72)_64deg,rgba(255,255,255,0.98)_78deg,rgba(255,255,255,0.62)_94deg,rgba(255,255,255,0.04)_138deg,rgba(255,255,255,0)_220deg,rgba(255,255,255,0.68)_292deg,rgba(255,255,255,1)_320deg,rgba(255,255,255,0)_360deg)] blur-[0.4px]" />
          </motion.div>
          <div className="pointer-events-none absolute inset-[1.2px] rounded-[23px] border border-white/12 bg-[rgba(0,0,0,0.52)]" />
          <div className="pointer-events-none absolute inset-[1.2px] rounded-[23px] bg-[radial-gradient(circle_at_12%_0%,rgba(255,255,255,0.16),transparent_38%),radial-gradient(circle_at_88%_12%,rgba(255,255,255,0.1),transparent_44%)]" />
          <div className="pointer-events-none absolute inset-[1.2px] rounded-[23px] bg-[linear-gradient(180deg,rgba(255,255,255,0.13)_0%,rgba(255,255,255,0.03)_34%,rgba(255,255,255,0)_76%)]" />
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
            <div className="lg:col-span-5">
              <div className="relative mb-6 inline-block">
                <div className="pointer-events-none absolute -inset-4 rounded-2xl bg-[radial-gradient(circle,rgba(255,255,255,0.22)_0%,rgba(255,255,255,0.1)_28%,rgba(255,255,255,0.04)_42%,transparent_72%)] blur-lg" />
                <Link
                  href="/"
                  aria-label="INFLUCITY - Home"
                  className="relative block shrink-0 no-underline transition-opacity hover:opacity-90"
                >
